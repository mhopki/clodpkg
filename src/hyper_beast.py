...
def capture(data):
    ...
    resmatrix = np.array([[ 4.26587357e-01, -1.83178642e-02, -1.61656625e+02],
                        [-1.20780273e-02,  3.95505365e-01, -8.88106650e+01],
                        [ 4.43942015e-05, -6.67004105e-05,  1.00000000e+00]])

    resmatrix = np.array([[-3.37383838e+00, -9.51902255e-02,  3.77450366e+03],
                          [-4.01830806e-01, -3.26958544e+00,  5.30820011e+03],
                          [-8.26241017e-04, -3.64712975e-04,  1.00000000e+00]])

    # resmatrix = np.eye(3)

    rgb_cord = [x,y,1]

    hsc_cord = resmatrix @ rgb_cord
    print('hsc', hsc_cord)
    hsc_cord[0] = int(hsc_cord[0] - 320)  #TODO: this might need to be changed
    hsc_cord[1] = int(320 - hsc_cord[1])  #TODO: this might need to be changed
    ...
    pixelx, pixely = (hsc_cord[0] * 15, hsc_cord[1] * 15)   #TODO: this might need to be changed

    top = pixely + 320      #TODO: this might need to be changed
    bottom = pixely - 320   #TODO: this might need to be changed
...
def spin():
    ...
    rospy.init_node('hyperspectral-node', anonymous=True)
