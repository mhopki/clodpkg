...
class ImageSegmentation:
    def __init__(self):
        ...
        self.image_sub = rospy.Subscriber('/yolov7/yolov7', Detection2DArray, self.yolo_callback)
        ...
        self.center_coordinates_pub = rospy.Publisher('/centerCoord', Float32MultiArray, queue_size=10)
    ...
    def yolo_callback(self, data):
        ...
        center_coordinates = (data.detections[0].bbox.center.x, data.detections[0].bbox.center.y)
        whv = (data.detections[0].bbox.size_x, data.detections[0].bbox.size_y)
        ...
        actual_height = 2  # Actual height of the object in centimeters
        if whv != (0, 0): 
        ...
        if whv != (0, 0):
            ...
            center_coordinates_msg = Float32MultiArray(data=[center_coordinates[0], center_coordinates[1]])
            self.world_coordinates_pub.publish(world_coordinates_msg)
            self.center_coordinates_pub.publish(center_coordinates_msg)
