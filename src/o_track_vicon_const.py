...
class POCont:
    ...
    def waypoint_callback(self, data):
        ...
        self.targ_vel = 0.1# self.waypoints[0].pose.position.z #Z is read in as Target Velocity
    ...
    def calculate_desired_heading(self, current_pose, waypoint_pose):
        ...
        return math.atan2(dy, dx)  # Calculate heading angle
    ...
    while not rospy.is_shutdown():
        ...
        anggain = 1.0 * 2.0      # Angular gain factor
